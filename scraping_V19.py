""" 
En el botón de datos abiertos YA se elige la carpeta destino, manda a web para verificar la carpeta a descargar.
LA VERSIÓN 19 Y 20 SON IGUALES CON LA DIFERENCIA DE QUE 19 ABRE EL ONEDRIVE PARA VERIFICAR Y 20 DESCARGA DIRECTO
"""
...
class ScraperApp:
    ...
    def descargar_archivos_seleccionados(self):
        ...
        if nube_links:                                                                          #Mensaje advirtiendo que se abrirá el navegador
            mensaje = f"Has seleccionado {len(nube_links)} enlace(s). \n\n"\
                        "Estos archivos requerirán una verificación del usuario al ser carpetas grandes.\n"\
                        "Se abrirá el navegador para que confirmes la descarga\n\n¿Continuar?"
            ...
            if messagebox.askyesno("Enlcaes de Nube", mensaje):
                ...
                if carpeta_nube:
                    ...
                    try:
                        ...
                        messagebox.showinfo("Proceso iniciado", "El navegador está descargando los archivos. \n Por favor, espere.")
    ...
    def procesar_verificacion(self, df):
        ...
        #NUEVOOOO Driver oculto para verificación robusta
        driver_oculto = None
