#En esta versión se mejora la muestra de búsquedas (muestra el filename completo) y pide los nomnbres de los archivos, además de sugerir el que se encontró.    #Esta SÍ SIRVE
import pandas as pd
import requests
import os
    ...
    def descargar_archivos_seleccionados(self):                                        # Función para descargar los archivos que eligió el usuario
        ...
        for i in indices_seleccionados:                                # Iteramos sobre los seleccionados
            ...
            try:
                ...
                # Headers para parecer navegador real (importante para gob.mx)
