"""
Se añade el botón que redigire a otra página para descargar la carpeta .zip de incidencias delictivas 
Se añade un scrollbar horizontal para cuando el texto sea más largo
Se añaden las ventanas del conversor y verificador
Se cambia la forma en que se presetan los nombres de datos abiertos
"""
...
class ScraperApp:
    def __init__(self, root):
        ...
        tk.Label(self.tab_verificador, text="Elige tu archivo para verificar: ", font=("Arial", 12, "bold")).pack(pady=(15,5))
        tk.Button(self.tab_verificador, text="Seleccionar", command = self.verificar_enlaces, bg="#FF9800", fg="white", height=2).pack(pady=10)
        ...
        tk.Button(self.tab_conversor, text="Seleccionar", command = self.convertir_archivos, bg="#FF9800", fg="white", height=2).pack(pady=10)
