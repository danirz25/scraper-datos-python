"""
Cambios generales de optimización.
Se le meten hilos al código para que que no se bloqueé la ventana al estar buscando. No es tan útil pero sí situacional
Hay un botón de X para quitar el link
Filtrado en tiempo real
Obtención del año para filtrar por años encontrados
"""
...
class ScraperApp:
    ...
    def escanear_archivos(self):                                                                
        try:
            ...
            #--- ACTUALIZACIÓN DE GUI EN EL HILO PRINCIPAL ---
            #Llamamos a una función segura para actualizar la ventana
            self.root.after(0, self.finalizar_busqueda_gui, contador)
