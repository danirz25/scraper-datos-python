#Esta versión tiene por objetivo descargar los archivos no todos juntos, sino en directorios por años.
import pandas as pd
import requests
import os
...
class ScraperApp:
    def __init__(self, root):
        ...
        tk.Button(frame_filtros, text="Quirar filtros", command=self.limpiar_filtros, bg = "#DDDDDD" ).pack(side="left")
        ...
        self.chk_organizar = tk.Checkbutton(self.tab_files, text="Organizar descargas en carpetas por año", variable=self.var_organizar_anio, fg= "blue")
